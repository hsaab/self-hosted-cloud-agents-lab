...
.PHONY: help docker-build docker-run ecr-login ecr-build-push ec2-put-api-key-secret helm-install-controller helm-create-api-key-secret helm-apply helm-delete k8s-create-api-key-secret k8s-apply k8s-delete ec2-terraform-init ec2-terraform-plan ec2-terraform-apply terraform-init terraform-plan
